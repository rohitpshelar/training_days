...
import com.ro.demo.repository.CommentRepository;
//import com.ro.demo.repository.VoteRepository;
...
//    private AuthService authService;
   ...
   // @Mapping(target = "subreddit", source = "subreddit") //  Not needed as filed name are same
    @Mapping(target = "voteCount", constant = "0")
   // @Mapping(target = "user", source = "user")//  Not needed as filed name are same
