...
public class CompetencyTestResultMapperImpl implements CompetencyTestResultMapper {
    ...
    @Override
    public CompetencyTestResult DtoToCompetencyTestResult(CompetencyTestResultDto competencyTestResultDto, String user) {
        if ( competencyTestResultDto == null && user == null ) {
            return null;
        }
        ...
        if ( user != null ) {
            competencyTestResult.setCtrUsername( user );
        }
        competencyTestResult.setCtrCreated( java.time.Instant.now() );
