	...
	<body>
		...
		<form action="editeds">
			<table align="center">
				...
				<tr>
					<td>
						<input type="radio" checked="checked" name="r" id="r"
							value="<%=rf.getRegid()%>">
					</td>
					<td>
						<%=rf.getRegid()%>
				...
				<tr>
					...
					<td>
						<input type="text" name="fn" value="<%=rf.getFname()%>">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="ln" value="<%=rf.getLname()%>">
					</td>
				</tr>
				<tr>
					<td valign="top">
					...
					<td valign="top">
						...
						Female
						<%}  if("1".equals(rf.getGender()))
							{
							String s="checked";
							%>
						<input type="radio" value="0" name="gen">
						male&nbsp;&nbsp;&nbsp;
						<input type="radio" checked="s" value="1" name="gen">
						Female
						<%} %>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="checkbox" name="lang" value="English"
							<% if(English.equals("English")){%> checked <%} %>>
						English
						<input type="checkbox" name="lang" value="Hindi"
							<%if(Hindi.equals("Hindi")){%> checked <%} %>>
						Hindi
						<input type="checkbox" name="lang" value="Marathi"
							<% if(Marathi.equals("Marathi")){%> checked <%} %>>
						Marathi
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="add" value="<%=rf.getAdder()%>">
					</td>
				</tr>
				<tr></tr>
				<tr></tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="un" value="<%=rf.getUname()%>">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="password" name="pw" value="<%=rf.getPass()%>">
					</td>
				</tr>
				<tr>
