					...
					<div class="nav-canvas">
						...
						<ul class="nav nav-pills nav-stacked main-menu">
							...
							<li><a class="ajax-link"
								href="${pageContext.request.contextPath}/jsp/adminPages/adminFront.jsp"><i
									class="glyphicon glyphicon-home"></i><span> Dashboard</span></a></li>
							<li><a class="ajax-link"
								href="${pageContext.request.contextPath}/jsp/adminPages/admin-new-registeration.jsp"><i
									class="glyphicon glyphicon-calendar"></i><span>
										Employee Registration </span></a></li>
							<li><a class="ajax-link"
								href="${pageContext.request.contextPath}/jsp/adminPages/admin-new-HR-registeration.jsp"><i
									class="glyphicon glyphicon-calendar"></i><span> HR
										Registration </span></a></li>
							<li class="accordion" id="flip"><a href="#"><i
									class="glyphicon glyphicon-plus"></i><span> Member
										Details</span></a>
								<ul id="panel" class="nav nav-pills nav-stacked">
									<li><a
										href="${pageContext.request.contextPath}/admin/employeedetails">Employee</a></li>
									<li><a
										href="${pageContext.request.contextPath}/admin/hrdetails">Human
											Resource</a></li>
								</ul></li>
							<li><a class="ajax-link"
								href="${pageContext.request.contextPath}/jsp_pages/adminPages/calender.jsp"><i
