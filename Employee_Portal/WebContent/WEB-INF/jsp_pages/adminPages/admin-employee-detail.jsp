...
function deleteemployee(id) {
	...
	if(isOK)
	{
		window.location.href="${pageContext.request.contextPath}/admin/deleteemployee?id="+id;
	}
}
</script>
     <script>
function UserContact(id) {
	...
	if(isOK)
	{
		window.location.href="${pageContext.request.contextPath}/admin/newempprofile?id="+id;
	}
}
...
function editContact(id) {
	...
	if(isOK)
	{
		window.location.href="${pageContext.request.contextPath}/admin/editEmployee?id="+id;
	}
}
</script>
