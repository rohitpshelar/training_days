...
<html>
	...
	popUpWithServerData("/ExtremityProject/addProduct.action", "ADD Product",450,550);
}
		...
		<form name="productForm" style="margin-bottom: -34px;">
			<jmesa:tableModel id="tag" items="${list}" maxRows="8"
				...
				<jmesa:htmlTable width="100%">
					<jmesa:htmlRow>
						<jmesa:htmlColumn property="pid" title="Bank Id">
							<input type="radio" name="productIdRadio" id="productIdRadio"
			onclick="setId(this)"					value="${bean.pid}" />
							<%--
					  set the bankid to radio button--%>

						</jmesa:htmlColumn>
						<jmesa:htmlColumn property="pname" title="Product Name" />
						<jmesa:htmlColumn property="price" title="Price" />
...
<input type="button" onclick="loadProducts()" value="Add Product">
