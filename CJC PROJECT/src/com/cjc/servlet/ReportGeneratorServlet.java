...
public class ReportGeneratorServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		try {
			...
			cell = new PdfPCell(new Paragraph("Email", FontFactory
					.getFont(FontFactory.TIMES_ROMAN, 13, Element.ALIGN_CENTER,
							BaseColor.BLUE)));
			cell.setFixedHeight(10);
			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			e.printStackTrace();
				...
				cell = new PdfPCell(new Paragraph("" + r.getEmail(), FontFactory
						.getFont(FontFactory.TIMES_ROMAN, 10, Element.ALIGN_CENTER,
								BaseColor.BLUE)));
				cell.setFixedHeight(40f);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				table1.addCell(cell);
				...
				cell = new PdfPCell(new Paragraph("" + r.getPass(), FontFactory
						.getFont(FontFactory.TIMES_ROMAN, 10, Element.ALIGN_CENTER,
								BaseColor.BLACK)));
